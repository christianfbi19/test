...
-- Library init
    getgenv().library = {
        ...
        MainColor = hex("#1C1C1C"),
        AccentColor = hex("#245771"),
        BackgroundColor = hex("#141414"),
        OutlineColor = hex("#323232"),
        AccentColorDark = hex("#1B4256"),
        ThemeObjects = {},
    }
    ...
    local themes = {
        utility = {
            MainColor = { BackgroundColor3 = {} },
            AccentColor = { BackgroundColor3 = {}, TextColor3 = {}, ImageColor3 = {}, ScrollBarImageColor3 = {} },
            AccentColorDark = { BackgroundColor3 = {} },
            BackgroundColor = { BackgroundColor3 = {} },
            OutlineColor = { BackgroundColor3 = {}, Color = {} },
            FontColor = { TextColor3 = {}, PlaceholderColor3 = {} },
        }
    }
...
-- Library functions 
    -- Misc functions
        ...
        function library:GetDarkerColor(color_value)
            return color_value:Lerp(Color3.new(0, 0, 0), 0.35)
        end
        ...
        function library:apply_theme(instance, theme, property) 
            ...
            bucket[property] = bucket[property] or {}
        ...
        function library:update_theme(theme, color)
            ...
            local registry = themes.utility[theme]
            if not registry then
                return
            end

            for property, objects in registry do 
        ...
        function library:UpdateColorsUsingRegistry()
            self:update_theme("MainColor", self.MainColor)
            self:update_theme("AccentColor", self.AccentColor)
            self:update_theme("AccentColorDark", self.AccentColorDark)
            self:update_theme("BackgroundColor", self.BackgroundColor)
            self:update_theme("OutlineColor", self.OutlineColor)
            self:update_theme("FontColor", self.FontColor)
        end

        function library:bind_hover(button, callback)
        ...
        function library:make_option(idx, option, is_toggle)
            if not idx then
                return option
            end

            option.Type = option.Type or "Option"
            option._changed = option._changed or {}
            option.OnChanged = function(self, callback)
                insert(self._changed, callback)
                return self
            end
        ...
        function library:fire_changed(option)
            if not option or not option._changed then
                return
            end

            for _, callback in option._changed do
                callback(option.Value)
            end
        end

        function library:Notify(text)
            notifications:create_notification({name = text})
        end
        ...
        function library:apply_stroke(parent) 
            ...
            library:apply_theme(STROKE, "OutlineColor", "Color")
        end
        ...
        function library:create(instance, options)
            ...
            if instance == "TextLabel" or instance == "TextButton" or instance == "TextBox" then 	
                library:apply_theme(ins, "FontColor", "TextColor3")
    ...
    -- Library element functions
        function library:window(properties)
            ...
            -- Window
                ...
                library:apply_theme(title_holder, "MainColor", "BackgroundColor3")
                ...
                local tab_button_holder = library:create("Frame", {
                    Parent = window_outline;
                    BackgroundTransparency = 0;
                    Position = dim2(0, 2, 0, 28);
                    BorderColor3 = rgb(0, 0, 0);
                    Size = dim2(1, -4, 0, 22);
                    BorderSizePixel = 0;
                    BackgroundColor3 = library.BackgroundColor
                }); cfg.tab_button_holder = tab_button_holder
                library:apply_theme(tab_button_holder, "BackgroundColor", "BackgroundColor3")
        ...
        function library:tab(properties)
            ...
            -- Instances 
                -- Tab Button
                    local tab_button = library:create("TextButton", {
                        ...
                        TextColor3 = library.FontColor:Lerp(Color3.new(0, 0, 0), 0.35);
                        BorderColor3 = rgb(0, 0, 0);
                        Text = cfg.name;
                    ...
                    library:apply_theme(tab_button, "AccentColorDark", "BackgroundColor3")
                -- 
                ...
                -- Page
                    ...
                    library:apply_theme(Page, "BackgroundColor", "BackgroundColor3")
            ...
            function cfg.open_tab() 
                ...
                if selected_tab then 
                    ...
                    selected_tab[2].TextColor3 = library.FontColor:Lerp(Color3.new(0, 0, 0), 0.35)
                    selected_tab[3].BackgroundTransparency = 1

                    selected_tab = nil 
                end

                Page.Visible = true
                tab_button.TextColor3 = library.FontColor
                tab_button.BackgroundTransparency = 0

                self.selected_tab = {Page, tab_button, tab_button}
            end
            ...
            library:bind_hover(tab_button, function(hovering)
                if self.selected_tab and self.selected_tab[2] == tab_button then
                    return
                end

                tab_button.BackgroundTransparency = hovering and 0.25 or 1
                tab_button.TextColor3 = hovering and library.FontColor or library.FontColor:Lerp(Color3.new(0, 0, 0), 0.35)
            end)
        ...
        function library:watermark(options)
            ...
            -- Instances
                ...
                library:apply_theme(outline, "AccentColor", "BackgroundColor3")
                ...
                library:apply_theme(dark, "MainColor", "BackgroundColor3")
	...
	fpsLabel.Text = "FPS: " .. tostring(math.floor(realFPS))
        ...
        function library:column(properties)
            ...
            local cfg = {color = library.AccentColor, count = self.count} 
        ...
        function library:section(properties)            
            ...
            -- Instances
                local accent = library:create("Frame", {
                    ...
                    BorderSizePixel = 0;
                    BackgroundColor3 = library.AccentColor
                }); library:apply_theme(accent, "AccentColor", "BackgroundColor3");
        ...
        -- Elements  
            function library:toggle(options) 
                ...
                -- Instances
                    -- Element
                        ...
                        local fill = library:create("Frame", {
                            ...
                            BorderSizePixel = 0;
                            BackgroundColor3 = library.AccentColor
                        }); library:apply_theme(fill, "AccentColor", "BackgroundColor3");                
                ...
                -- Functions
                    function cfg.set(bool)                        
                        fill.BackgroundColor3 = bool and library.AccentColor or library.MainColor
                        title.TextColor3 = bool and library.FontColor or library.FontColor:Lerp(Color3.new(0, 0, 0), 0.2)

                        flags[cfg.flag] = bool

                        cfg.callback(bool)
                        library:fire_changed(cfg)
                ...
                -- Connections
                    ...
                    library:bind_hover(toggle, function(hovering)
                        if cfg.enabled then
                            return
                        end

                        title.TextColor3 = hovering and library.FontColor or library.FontColor:Lerp(Color3.new(0, 0, 0), 0.2)
                    end)
                -- 
                ...
                cfg.SetValue = function(_, value)
                    cfg.set(value)
                end

                library:make_option(cfg.flag, cfg, true)
            ...
            function library:list(options)
                ...
                -- Elements
                    ...
                    local inline = library:create("Frame", {
                        ...
                        BorderSizePixel = 0;
                        BackgroundColor3 = library.MainColor
                    }); library:apply_theme(inline, "MainColor", "BackgroundColor3")
                ...
                -- Functions
                    ...
                    function cfg.refresh_options(options)
                        ...
                        for _, option in next, options do 
                            ...
                            library:bind_hover(button, function(hovering)
                                if cfg.current_instance == button then
                                    return
                                end

                                button.TextColor3 = hovering and library.FontColor or rgb(170, 170, 170)
                            end)
                        end 
                    end
            ...
            function library:slider(options) 
                ...
                library:make_option(cfg.flag, cfg, false)
                ...
                -- Instances
                    -- Element 
                        ...
                        local dropdown_holder = library:create("TextButton", {
                            ...
                            BorderSizePixel = 0;
                            BackgroundColor3 = library.AccentColor
                        }); library:apply_theme(dropdown_holder, "AccentColor", "BackgroundColor3")
                    ...
                    -- Holder
                        local accent = library:create("Frame", {
                            ...
                            AutomaticSize = Enum.AutomaticSize.Y;
                            BackgroundColor3 = library.AccentColorDark
                        });	library:apply_theme(accent, "AccentColorDark", "BackgroundColor3")
                ...
                -- Functions
                    ...
                    function cfg.refresh_options(list) 
                        ...
                        for _, option in next, list do 
                            ...
                            library:bind_hover(button, function(hovering)
                                local selected = cfg.multi and find(cfg.multi_items, button.Text) or text.Text == button.Text
                                if selected then
                                    return
                                end
                    ...
                    cfg.Type = "Dropdown"
                    cfg.Multi = cfg.multi
                    cfg.SetValues = function(_, values)
                        cfg.items = values
                        cfg.refresh_options(values)
                    end
                    cfg.SetValue = function(_, value)
                        cfg.set(value)
                    end
            ...
            function library:colorpicker(options) 
                ...
                -- Instances
                    ...
                    -- Elements
                        local colorpicker = library:create("Frame", {
                            ...
                            BorderSizePixel = 0;
                            BackgroundColor3 = library.AccentColorDark
                        });	library:apply_theme(colorpicker, "AccentColorDark", "BackgroundColor3")
                        ...
                        local a = library:create("Frame", {
                            ...
                            BorderSizePixel = 0;
                            BackgroundColor3 = library.AccentColor
                        }); library:apply_theme(a, "AccentColor", "BackgroundColor3")
                        ...
                        local textbox_holder = library:create("Frame", {
                            ...
                            BorderSizePixel = 0;
                            BackgroundColor3 = library.AccentColor
                        }); library:apply_theme(textbox_holder, "AccentColor", "BackgroundColor3")
                        ...
                        local textbox = library:create("TextBox", {
                            ...
                            BackgroundColor3 = library.MainColor
                        }); library:apply_theme(textbox, "MainColor", "BackgroundColor3")
                        ...
                        local hue_button = library:create("TextButton", {
                            ...
                            BorderSizePixel = 0;
                            BackgroundColor3 = library.MainColor
                        }); library:apply_theme(hue_button, "MainColor", "BackgroundColor3")
                        ...
                        local alpha_button = library:create("TextButton", {
                            ...
                            BorderSizePixel = 0;
                            BackgroundColor3 = library.MainColor
                        }); library:apply_theme(alpha_button, "MainColor", "BackgroundColor3")
                        ...
                        local saturation_value_button = library:create("TextButton", {
                            ...
                            BorderSizePixel = 0;
                            BackgroundColor3 = library.MainColor
                        }); library:apply_theme(saturation_value_button, "MainColor", "BackgroundColor3")
                ...
                -- Functions 
                    ...
                    cfg.SetValueRGB = function(_, value, transparency)
                        cfg.set(value, transparency)
                    end
                    library:make_option(cfg.flag, cfg, false)
                -- 
            ...
            function library:textbox(options) 
                ...
                -- Instances 
                    local frame = library:create("TextButton", {
                        ...
                        BorderSizePixel = 0;
                        BackgroundColor3 = library.AccentColor
                    }); library:apply_theme(frame, "AccentColor", "BackgroundColor3")
                    ...
                    local frame_inline = library:create("Frame", {
                        ...
                        BorderSizePixel = 0;
                        BackgroundColor3 = library.MainColor
                    }); library:apply_theme(frame_inline, "MainColor", "BackgroundColor3")
                ...
                -- Instances
                    -- Element 
                        ...
                        local keybind_holder = library:create("TextButton", {
                            ...
                            BorderSizePixel = 0;
                            BackgroundColor3 = library.AccentColor
                        }); library:apply_theme(keybind_holder, "AccentColor", "BackgroundColor3")
                    ...
                    -- Holder
                        ...
                        for _, v in options do
                            ...
                            library:bind_hover(option, function(hovering)
                                if cfg.mode == v then
                                    return
                                end

                                option.TextColor3 = hovering and library.FontColor or rgb(170, 170, 170)
                            end)
                        end
                    --  
                --
            ...
            function library:button(options) 
                ...
                -- Connections 
                    ...
                    library:bind_hover(frame, function(hovering)
                        frame_inline.BackgroundColor3 = hovering and library.BackgroundColor or library.MainColor
                    end)
                --
            ...
            function library:label(options)
                local cfg = {
                    name = type(options) == "table" and (options.name or options.text or options.Text) or options or "Label",
                }

                cfg.Instance = library:create("TextLabel", {
                    Parent = self.elements;
                    BackgroundTransparency = 1;
                    BorderSizePixel = 0;
                    TextXAlignment = Enum.TextXAlignment.Left;
                ...
                cfg.SetText = function(_, text)
                    cfg.name = text
                    cfg.Instance.Text = text
                end

                return setmetatable(cfg, library)
            end

            function library:divider(text)
                return self:label({name = text and ("---- " .. text .. " ----") or "----------------"})
            end

            function library:_normalize_options(idx, options)
                local out = options or {}
                out.flag = out.flag or idx
                out.name = out.name or out.Name or out.Text or idx
                out.default = out.default == nil and out.Default or out.default
                out.items = out.items or out.values or out.Values
                out.multi = out.multi == nil and out.Multi or out.multi
                out.color = out.color or out.Color or out.Default
                out.min = out.min or out.Min
                out.max = out.max or out.Max
                out.interval = out.interval or out.Rounding or out.Interval
                out.suffix = out.suffix or out.Suffix
                if type(out.default) == "number" and type(out.items) == "table" then
                    out.default = out.items[out.default]
                end
                return out
            end

            function library:AddTab(name)
                return self:tab({name = type(name) == "table" and (name.Title or name.Name or name.name) or name})
            end

            function library:AddLeftGroupbox(name)
                self.left_column = self.left_column or self:column({})
                return self.left_column:section({name = name})
            end

            function library:AddRightGroupbox(name)
                self.right_column = self.right_column or self:column({})
                return self.right_column:section({name = name})
            end

            function library:AddToggle(idx, options)
                return self:toggle(self:_normalize_options(idx, options))
            end

            function library:AddButton(name, callback)
                local created = self:button({name = name, callback = callback})
                return setmetatable({
                    AddButton = function(_, next_name, next_callback)
                        return self:AddButton(next_name, next_callback)
                    end
                }, {__index = created})
            end

            function library:AddDropdown(idx, options)
                return self:dropdown(self:_normalize_options(idx, options))
            end

            function library:AddSlider(idx, options)
                return self:slider(self:_normalize_options(idx, options))
            end

            function library:AddInput(idx, options)
                local normalized = self:_normalize_options(idx, options)
                normalized.placeholder = normalized.placeholder or normalized.Placeholder or normalized.name
                return self:textbox(normalized)
            end

            function library:AddKeyPicker(idx, options)
                local normalized = self:_normalize_options(idx, options)
                if type(normalized.default) ~= "boolean" then
                    normalized.key = normalized.default or normalized.key
                    normalized.default = normalized.Active or false
                end
                return self:keybind(normalized)
            end

            function library:AddColorPicker(idx, options)
                local normalized = self:_normalize_options(idx, options)
                normalized.color = normalized.color or library.AccentColor
                return self:colorpicker(normalized)
            end

            function library:AddLabel(text)
                local section = self
                local label_text = type(text) == "table" and (text.Text or text.Name or text.name) or text
                local created = section:label(label_text)

                created.AddColorPicker = function(_, idx, options)
                    options = options or {}
                    options.name = label_text
                    return section:AddColorPicker(idx, options)
                end

                created.AddKeyPicker = function(_, idx, options)
                    options = options or {}
                    options.name = label_text
                    return section:AddKeyPicker(idx, options)
                end
            ...
            function library:AddDivider(text)
                return self:divider(text)
            end

            function library:AddToggleColorPicker(idx, toggle_options, color_idx, color_options)
                local toggle = self:AddToggle(idx, toggle_options)
                local picker = self:AddColorPicker(color_idx, color_options)
                return toggle, picker
            end

            function library:AddToggleColorPickers(idx, toggle_options, first_idx, first_options, second_idx, second_options)
                local toggle = self:AddToggle(idx, toggle_options)
                local first = self:AddColorPicker(first_idx, first_options)
                local second = self:AddColorPicker(second_idx, second_options)
                return toggle, first, second
            end

            function library:AddToggleKeyPicker(idx, toggle_options, key_idx, key_options)
                local toggle = self:AddToggle(idx, toggle_options)
                local keybind = self:AddKeyPicker(key_idx, key_options)
            ...
            function library:init_config(window) 
                ...
                section:colorpicker({name = "Accent color", callback = function(color)
                    library:update_theme("AccentColor", color)
                    library:update_theme("AccentColorDark", library:GetDarkerColor(color))
                end, color = library.AccentColor})
                section:colorpicker({name = "Main color", callback = function(color)
                    library:update_theme("MainColor", color)
                end, color = library.MainColor})
                section:colorpicker({name = "Background color", callback = function(color)
                    library:update_theme("BackgroundColor", color)
                end, color = library.BackgroundColor})
